...
var de_OptInPhoneNumberCommandError = /* @__PURE__ */ __name(async (output, context) => {
  const parsedOutput = {
    ...output,
    body: await parseErrorBody(output.body, context)
  };
...
var de_VerifySMSSandboxPhoneNumberCommandError = /* @__PURE__ */ __name(async (output, context) => {
  const parsedOutput = {
    ...output,
    body: await parseErrorBody(output.body, context)
  };
...
}, "de_VerifySMSSandboxPhoneNumberCommandError");
